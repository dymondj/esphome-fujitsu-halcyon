...
class FujitsuHalcyonController : public Component, public climate::Climate, public uart::UARTDevice, public tzsp::TZSPSender {
    public:
        ...
        CustomSwitch* zone_1_switch = new CustomSwitch([this](bool state) { return this->controller->set_zone(ZoneFields::Zone1, state, this->ignore_lock_); });
        CustomSwitch* zone_2_switch = new CustomSwitch([this](bool state) { return this->controller->set_zone(ZoneFields::Zone2, state, this->ignore_lock_); });
        CustomSwitch* zone_3_switch = new CustomSwitch([this](bool state) { return this->controller->set_zone(ZoneFields::Zone3, state, this->ignore_lock_); });
        CustomSwitch* zone_4_switch = new CustomSwitch([this](bool state) { return this->controller->set_zone(ZoneFields::Zone4, state, this->ignore_lock_); });
        CustomSwitch* zone_5_switch = new CustomSwitch([this](bool state) { return this->controller->set_zone(ZoneFields::Zone5, state, this->ignore_lock_); });
        CustomSwitch* zone_6_switch = new CustomSwitch([this](bool state) { return this->controller->set_zone(ZoneFields::Zone6, state, this->ignore_lock_); });
        CustomSwitch* zone_7_switch = new CustomSwitch([this](bool state) { return this->controller->set_zone(ZoneFields::Zone7, state, this->ignore_lock_); });
        CustomSwitch* zone_8_switch = new CustomSwitch([this](bool state) { return this->controller->set_zone(ZoneFields::Zone8, state, this->ignore_lock_); });
